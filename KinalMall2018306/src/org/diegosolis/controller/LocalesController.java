...
@Override
    ...
    public void cargarDatos(){
        ...
        colCodigoLocales.setCellValueFactory(new PropertyValueFactory<Locales,Integer>("codigoLocal"));
 ...
 public void seleccionarElemento(){
        ...
        txtCodigoLocales.setText(String.valueOf(((Locales)tblLocales.getSelectionModel().getSelectedItem()).getCodigoLocal()));
    ...
    public void nuevo(){
        switch(tipoDeOperaciones){
            case NINGUNO:
                ...
                tipoDeOperaciones = LocalesController.operaciones.GUARDAR;
                break;
            case GUARDAR:
                guardar();
                desactivarControles();
                ...
                tipoDeOperaciones = LocalesController.operaciones.NINGUNO;
                cargarDatos();
                break;
        }
    }
        ...
        switch(tipoDeOperaciones){
            case NINGUNO:
                if (tblLocales.getSelectionModel().getSelectedItem()!= null){
                    ...
                    activarControles();
                    tipoDeOperaciones = LocalesController.operaciones.ACTUALIZAR;
                }else{
                    JOptionPane.showMessageDialog(null,"Debe Seleccionar un elemento");
                }
                break;
